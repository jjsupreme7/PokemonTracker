...
export function FolderIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 012.25-2.25h7.5A2.25 2.25 0 0118 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 004.5 9v.878m13.5-3A2.25 2.25 0 0119.5 9v.878m0 0a2.246 2.246 0 00-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0121 12v6a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-6c0-1.085.768-1.99 1.789-2.21" />
    </svg>
  );
}
...
export function PokeballIcon({ className, filled }: { className?: string; filled?: boolean }) {
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M1 12h8.5a2.5 2.5 0 005 0H23" stroke="currentColor" strokeWidth="1.5" fill="none" />
